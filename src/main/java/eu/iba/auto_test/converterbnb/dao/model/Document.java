...
public class Document {
    ...
    // Признак того что регистрация была пропущена
    private Boolean skipRegistration = Boolean.FALSE;
    ...
    // Способ доставки для входящего документа и обращения
    ...
    // Ids задач ознакомления
    List<Long> introductionIds = new ArrayList<>();
    ...
    public List<Long> getIntroductionIds() {
        return introductionIds;
    }

    public Document setIntroductionIds(List<Long> introductionIds) {
        this.introductionIds = introductionIds;
        return this;
    }
    ...
    public Document setTaskComments(List<TaskComment> taskComments) {
    ...
    public Document setSkipRegistration(Boolean skipRegistration) {
