...
public class ReviewTaskParentSqlFunction extends SqlFunction<TaskGeneral> {
    ...
    private static final String SQL ="SELECT DISTINCT task.XRecID as id, task.Author as authorId, p.NameAn as authorFullName, p.Dop as authorLoginAD " +
            "FROM SBTask task " +
            "LEFT JOIN MBAnalit rkk ON task.XRecID = rkk.IntNumber3 " +
    ...
    public ReviewTaskParentSqlFunction(DataSource ds, Map<String, Object> mapParam) {
        super(ds, SQL);
