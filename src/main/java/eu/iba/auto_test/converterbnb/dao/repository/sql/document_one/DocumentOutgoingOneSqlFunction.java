...
//исходящий
public class DocumentOutgoingOneSqlFunction extends SqlFunction<Document> {
    ...
    private static final String SQL ="SELECT DISTINCT rkk.XRecID as id, rkk.PriznDok as documentCategoryConstants, " +
            ...
            "whoSigned.Analit as employeeId, whoSigned.NameAn as employeeFullName, whoSigned.Dop as employeeLoginAD, " +
    ...
    public DocumentOutgoingOneSqlFunction(DataSource ds, Map<String, Object> mapParam) {
        super(ds, SQL);
